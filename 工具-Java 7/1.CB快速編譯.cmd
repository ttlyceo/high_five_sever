...
:_check_copy
if exist "CB-Support.txt" goto _check_copy_next
...
if not exist "2.CB*.cmd" goto _UPDATE
...
if exist "%ProgramFiles%\Java\%ver%\lib\ant_184cb.txt" goto _JAVA_VER_NEXT
echo.>> "%ProgramFiles%\Java\%ver%\lib\ant_184cb.txt"
if not exist "%ProgramFiles%\Java\%ver%\lib\ant_184cb.txt" goto _NO_ACCESS
...
if exist "build\*.zip" echo ■■■■■■■■■■■
if exist "build\*.zip" echo ■ 　CB編譯成功！ 　■
if exist "build\*.zip" echo ■■■■■■■■■■■
echo.
