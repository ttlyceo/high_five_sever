...
if exist "%ProgramFiles%\Java\%ver%\lib\ant_194gs.txt" goto _JAVA_VER_NEXT
echo.>> "%ProgramFiles%\Java\%ver%\lib\ant_194gs.txt"
if not exist "%ProgramFiles%\Java\%ver%\lib\ant_194gs.txt" goto _NO_ACCESS
